	...
	function	renderWalletButton() {
		if (!active) {
			return (
				<button
					...
					className={'inline-flex px-3 py-2 items-center leading-4 text-sm cursor-pointer whitespace-nowrap text-gay-900 border border-solid border-ygray-200 font-mono bg-white'}>
		...
		return (
			<p
				...
				className={'inline-flex px-3 py-2 items-center leading-4 text-sm cursor-pointer whitespace-nowrap text-gray-900 border border-solid border-ygray-200 font-mono bg-white'}>
