...
## /api/strategies
This route is accessible to this URI and resolve the list of strategies for a specific Vault.
```
https://ape.tax/api/strategies
```
...
The returned data is cached for 60 minutes.
This route returns a JSON object with the following structure:
```json
[{
	"address": "0xf6D87dFC0841A289614B3d6fdb78D956ebd3cfF0",
